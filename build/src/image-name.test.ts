...
test.each([
  ...
  '../mica-x64-20260909-164233.img', 'mica-x64-20260230-164233.img',
  'mica-x64-20260229-164233.img', 'mica-x64-20261301-164233.img',
  'mica-x64-20260909-240000.img', 'mica-x64-20260909-166033.img',
  'mica-x64-20260909-164260.img', 'mica-x64-20260909-1642.img',
  'mica-x64-20260909-164233.img.old',
...
test('leap dates are accepted and invalid build inputs are refused', () => {
  expect(isFactoryImageFilename('mica-x64-20280229-000000.img', 'x64')).toBe(true)
