...
The mini-arm64 board of Mica OS: the generic UEFI/ACPI arm64 machine (user,
2026-09-16 -- the generic systems are uefi-x64 and mini-arm64; cx3576 and
...
board evidence (`evidence.json`). One board of `micaoss/mica-boards`; `make mini-arm64-kernel`, `make pool` and
