#!/usr/bin/env bash
# Can tests/gates/host-toolchain-lint.sh fail?
#
...
# mica:docs/design/build-harness.md section 4's empty-mount trap cannot apply.
#
#   bash tests/gates/host-toolchain-lint-test.sh     (or: make os-host-toolchain-lint-test)
set -euo pipefail

REPO="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
LINT="${REPO}/tests/gates/host-toolchain-lint.sh"
