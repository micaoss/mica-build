...
#
#   bash tests/gates/runtime-soname-scan.sh <product>   (make os-soname-scan PRODUCT=<name>)
#
...
#
# tests/fixtures/runtime-sonames.json holds the classes of names that are absent ON
...
python3 - "${work}/names.tsv" tests/fixtures/runtime-sonames.json "${product}" <<'PY'
import json, sys
