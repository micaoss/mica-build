...
`BUILD_CONTEXTS` and in no `stages/compose` Dockerfile context.
...
bash tests/suites/p1-writable-path-audit/extract-root.sh uefi-x64-dev
bash tests/suites/p1-writable-path-audit/audit-root.sh  uefi-x64-dev
...
MICA_PRODUCT=uefi-x64-dev bash tests/suites/p1-writable-path-audit/boot.sh observe   observe
MICA_PRODUCT=uefi-x64-dev bash tests/suites/p1-writable-path-audit/boot.sh candidate candidate
bash tests/suites/p1-writable-path-audit/boot.sh verify    verify
```
