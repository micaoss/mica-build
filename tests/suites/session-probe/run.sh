...
#
#   bash tests/suites/session-probe/run.sh <product>     (make os-session-probe PRODUCT=<name>)
#
...
qemu 1 --seed "${REPO_ROOT}/tests/suites/session-probe/probe.sh" /state/mica-session-probe.sh \
    "${REPO_ROOT}/tests/suites/session-probe/probe.service" /state/systemd-units/mica-session-probe.service \
