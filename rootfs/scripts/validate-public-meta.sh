...
bun_image=$(bash "${repo_root}/bin/bun.sh" src/cli.ts from --ref mica-build-env:base)
...
if (document.schema !== "mica/meta/v1") fail("schema", "must equal the current schema mica/meta/v1")
